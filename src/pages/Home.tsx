...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="col-span-12 md:col-span-7 p-10 md:p-20 flex flex-col justify-between relative z-10 text-center md:text-left items-center md:items-start">
          <div>
            <motion.h1 
              ...
              className="text-[18vw] md:text-[140px] leading-[0.8] font-black uppercase tracking-tighter mb-8 italic"
            >
              JACKY'S<br/><span className="text-amber-500">BAKERY</span>
            </motion.h1>
            <p className="text-lg md:text-2xl leading-relaxed opacity-80 max-w-md font-light serif italic mx-auto md:mx-0">
          ...
          {settings?.cakeOfTheDay && (
            <motion.div 
              ...
              className="bg-amber-600 p-8 text-black transform -rotate-2 max-w-sm"
            >
              <span className="block text-[10px] uppercase font-bold tracking-widest mb-2 opacity-70">Cake of the Day</span>
              <h2 className="text-4xl font-black uppercase tracking-tight">{settings.cakeOfTheDay}</h2>
      ...
      {/* Intro Section */}
      <section className="py-24 md:py-40 px-6 md:px-10 border-b border-white/10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-10 md:gap-20">
          <div className="md:col-span-4 flex flex-col justify-end pb-4 md:pb-10 text-center md:text-left items-center md:items-start">
          ...
          <div className="md:col-span-4 aspect-[3/4] overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 border border-white/10 max-w-sm mx-auto w-full">
            <img 
          ...
          <div className="md:col-span-4 flex flex-col justify-center space-y-6 md:space-y-8 text-base md:text-lg leading-relaxed font-light opacity-80 serif italic text-center md:text-left items-center md:items-start">
            <p>
